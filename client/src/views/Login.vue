  ...
  <div v-if="!getIsLoading">
    <div class="login-page log-block">
        <div class="login-form">
            <div class="abs-img1" data-aos-delay="100" data-aos-duration="1000" data-aos="fade-right">
                <img src="/img/img1.png" alt="">
            </div>

            <div class="abs-img2" data-aos-delay="600" data-aos-duration="1000" data-aos="fade-left">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loginHandler(){
                if(this.loginUsername === '') this.setErrors({username:'Username is required'})
                else{
                    const user ={
...
<style>
    ...
    .log-block .simple-input:before{
        ...
        filter: invert(66%) sepia(75%) saturate(359%) hue-rotate(129deg) brightness(90%) contrast(87%);
    }
    ...
    .register-page .login-btn:hover{
        background: #fff;
        color:#41c8c5;
        box-shadow: 0 5px 10px rgba(255,255,255,.4);
    }
    ...
    .open-btn{
        ...
        top:25px;
        cursor: pointer;
        transition: right .5s, top .5s, width .5s, height .5s, border-radius .3s, box-shadow .5s;
        z-index: 2;
        overflow: hidden;
    }
